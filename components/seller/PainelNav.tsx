...
import { User, CreditCard, Ticket, HeadphonesIcon, HelpCircle, BookOpen, ExternalLink, Link2, Users, ClipboardList } from "lucide-react";
...
const NAV = [
  ...
  { href: "/painel/plano-de-acao", label: "Plano de Ação", icon: ClipboardList },
...
export function PainelNav({ sellerName, sellerSlug, companySlug, photoUrl, logoutButton, modeSwitcher }: Props) {
